const fa = {
  ...
  settings: {
    ...
    serverPolicyHint:
      'این موارد روی سرور تعیین می‌شوند و در این دستگاه قابل تغییر نیستند. با هر بار اتصال به سرور به‌روزرسانی می‌شوند. ورود دستی شناسه تگ هم دیگر یک تنظیم نیست و بر اساس سطح دسترسی کاربر واردشده تعیین می‌شود.',
    policyOn: 'فعال',
    policyOff: 'غیرفعال',
