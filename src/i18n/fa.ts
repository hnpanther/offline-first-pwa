const fa = {
  ...
  nfc: {
    ...
    // Says *why*, because the operator cannot fix this themselves and the old wording sent
    // them to a Settings screen that no longer has the switch.
    manualEntryDisabled: 'ورود دستی شناسه تگ برای سطح دسترسی شما مجاز نیست',
  ...
  logSheet: {
    ...
    continueReopened: 'ادامه‌ی کار',
    continueReopenedHint:
      'سرپرست این کار را با مهلت جدید بازگشایی کرده است. با زدن این دکمه، کار دوباره به پیش‌نویس برمی‌گردد و مقادیر واردشده حفظ می‌شود؛ پس از اصلاح، دوباره «ثبت نهایی» را بزنید.',
    continueReopenedSuccess: 'کار دوباره قابل ویرایش شد. پس از اصلاح، «ثبت نهایی» را بزنید.',
    continueReopenedRequiresOnline:
      'برای ادامه‌ی این کار باید به سرور دسترسی داشته باشید؛ بازگشایی باید از سرور تأیید شود.',
    continueReopenedFailed: 'بررسی وضعیت این کار روی سرور ناموفق بود. دوباره تلاش کنید.',
  ...
  settings: {
    ...
    serverPolicyTitle: 'قواعد تعیین‌شده توسط سرور',
    serverPolicyHint:
      'این موارد روی سرور تعیین می‌شوند و در این دستگاه قابل تغییر نیستند. با هر بار اتصال به سرور به‌روزرسانی می‌شوند.',
    policyOn: 'فعال',
    policyOff: 'غیرفعال',
    adminOnly: 'تغییر این گزینه فقط برای مدیر سامانه امکان‌پذیر است.',
    strictSerialMatch: 'بررسی سریال تراشه هنگام اسکن لاگ شیت',
    strictSerialMatchHint:
      'علاوه بر محتوای Record 1، سریال سخت‌افزاری تراشه هم باید با سریال ثبت‌شده روی دارایی یکسان باشد. محتوای Record 1 قابل کپی روی هر تگ خامی است، پس بررسی سریال همان چیزی است که به «تگ درست را اسکن کردم» معنا می‌دهد.',
    manualTagEntry: 'ورود دستی شناسه تگ NFC',
    manualTagEntryHint:
      'وقتی فعال باشد، کاربری که دسترسی «ورود دستی تگ» دارد می‌تواند به‌جای اسکن، شناسه تگ را تایپ کند. این کلید و آن دسترسی با هم لازم‌اند: اگر اینجا غیرفعال باشد هیچ کاربری — حتی مدیر — نمی‌تواند تگ را دستی وارد کند.',
    manualTagEntryYou: 'برای شما در این دستگاه',
    imageAnnotation: 'علامت‌گذاری روی عکس پیش از ذخیره',
    imageAnnotationHint:
      'پس از گرفتن عکس، پیش‌نمایش باز می‌شود و می‌توانید روی تصویر خط، فلش، کادر یا متن اضافه کنید. تصویر نهایی با همان علامت‌ها ذخیره و ارسال می‌شود.',
    ...
    screenOrientationApplied: 'قفل جهت صفحه اعمال شد.',
    screenOrientationAutoActive: 'جهت صفحه آزاد است و با چرخش دستگاه تغییر می‌کند.',
    // The one failure someone can act on, so it says what to do rather than what went wrong.
    screenOrientationNotInstalled:
      'قفل جهت اعمال نشد، چون برنامه در تب مرورگر باز شده است. برنامه را از آیکون نصب‌شده روی صفحهٔ اصلی باز کنید تا قفل جهت کار کند.',
    screenOrientationRefused:
      'این دستگاه اجازهٔ قفل جهت صفحه را نداد و صفحه آزادانه می‌چرخد. اگر قفل چرخش خودِ دستگاه فعال است، آن را بررسی کنید.',
    save: 'ذخیره',
  ...
  attachments: {
    ...
    annotateRect: 'کادر',
    annotateText: 'متن',
    annotateUndo: 'برگرداندن',
    annotateRedo: 'انجام دوباره',
    annotateClear: 'پاک کردن همه علامت‌ها',
    annotateWidth: 'ضخامت',
    annotateTextLabel: 'متن روی تصویر',
    annotateTextAdd: 'افزودن',
    annotateRetake: 'گرفتن دوباره',
    annotateSave: 'ذخیره با علامت‌ها',
    annotateSavePlain: 'ذخیره بدون تغییر',
    annotateLoadFailed: 'نمایش تصویر ممکن نشد.',
    annotateSaveFailed: 'ذخیره تصویر علامت‌گذاری‌شده ناموفق بود. دوباره تلاش کنید.',
  ...
  restoreArchived: {
    action: 'بازگرداندن مقادیر',
    title: 'بازگرداندن مقادیر به فرم فعلی',
    intro: 'این مقادیر را قبلاً خودتان ثبت کرده بودید. هر دارایی را که می‌خواهید به فرم فعلی برگردد انتخاب کنید.',
    mine: 'مقدار شما',
    current: 'مقدار فعلی',
    empty: 'خالی',
    yes: 'بله',
    no: 'خیر',
    conflictChip: 'مقدار فعلی جایگزین می‌شود',
    conflictWarning: 'برای {{count}} دارایی، فرم فعلی هم‌اکنون مقدار دارد و ممکن است توسط کاربر دیگری ثبت شده باشد. این موارد پیش‌فرض انتخاب نشده‌اند.',
    mediaCount: '{{count}} فایل',
    missingMedia: '{{count}} فایل دیگر روی این دستگاه موجود نیست و بازنمی‌گردد.',
    missingWarning: '{{count}} فایل دیگر روی این دستگاه موجود نیست. بقیه فایل‌ها برمی‌گردند.',
    confirm: 'بازگرداندن {{count}} دارایی',
    done: '{{count}} دارایی به فرم فعلی بازگردانده شد. برای ثبت نهایی، فرم را باز کنید و تأیید کنید.',
    nothing: 'چیزی برای بازگرداندن وجود ندارد.',
    failed: 'بازگرداندن مقادیر انجام نشد.',
    refusalNoArchive: 'نسخه آرشیوی دیگر موجود نیست.',
    refusalNoLiveSheet: 'فرم فعلی روی این دستگاه موجود نیست. پس از همگام‌سازی دوباره تلاش کنید.',
    refusalNotYourWork: 'این فرم در حال حاضر به شما اختصاص ندارد.',
    refusalNotEditable: 'این فرم دیگر قابل ویرایش نیست.'
  },
} as const
